    ...
    public class CityController : ControllerBase
    {
        ...
        public async Task<ActionResult<City>> Get(string cityname)
        {
            try
           {
                ...
                if (x != null)
                {
                    string modifyTime = $"Last updated Time is {x.modifiedtime}";
                    string apiResponse = $"Temperature in {x.Name} : {x.tempData}°C";
               ...
               else
                {
                    ...
                    if (timeDifference.TotalMinutes >= 30)
                    {
                        ...
                        cto.tempData = temperature1;
                        cto.modifiedtime = b.Modifitime;
                        cto.Name = b.CityName;
                        cto.Id = b.CityId;
                        cto.Latitude = Lat1;
                        cto.Longitude = Log1;
